...
<html lang="en">
    ...
    <body>
        ...
        <header>
            ...
            <!-- QUIZ CHANGE BOX -->
            <div id="quiz-change-form" class="modal">
                <form action="ChangeQuizInfo?quizID=${quiz.getQuizID()}" method="POST" class="modal-content animate">
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td> Quiz ID:</td>
                            <td><input disabled="" type="text" value="${quiz.getQuizID()}" readonly/>
                        ...
                        <tr>
                            <td> Lesson ID:</td>
                            <td>
                                <input type="number" name="lessonID" value="${quiz.getLessonID()}"/>
                            </td>
                        </tr>
                        <tr>
                            <td> Quiz Name:</td>
                            <td><input type="text" name="quizName" value="${quiz.getQuizName()}"/></td>
                        </tr>
                        <tr>
                            <td> Quiz Level</td>
                            <td><input type="text" name="level" value="${quiz.getLevel()}"/>
                        </tr>
                        <tr>
                            <td> Duration</td>
                            <td><input type="number" name="duration" value="${quiz.getDuration()}"/>
                        </tr>
                        <tr>
                            <td> Pass Rate:</td>
                            <td><input type="float" name="passRate" value="${quiz.getPassRate()}"/></td>
                        </tr>
                        <tr>
                            <td> Quiz Type</td>
                            <td><input type="text" name="quizType" value="${quiz.getQuizType()}"/>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2"><input class="login-btn" type="submit" value="Change"></td>
                                <c:if test="${empty requestScope.INVALID}">
                                <td>                        
                                    <button class="login-btn" type="reset" onclick="document.getElementById('quiz-change-form').style.display = 'none'">Cancel</button></td>
                                </c:if>
                        </tr>
                    </table>
                </form>         
                ...
                <form action="AddQuiz" method="POST" class="modal-content animate">
                    <table>
                        ...
                        <tr>
                            <td> Lesson ID:</td>
                            <td>
                                <input type="number" name="lessonID"/>
                            </td>
                        </tr>
                        <tr>
                            <td> Quiz Name:</td>
        ...
        <main>
            ...
            <div class="course-details-container" style="width: 100%;">
                ...
                <c:if test="${!quiz.isIsTaken()}">
                    <button onclick="document.getElementById('quiz-change-form').style.display = 'block'" class="login-btn"
                            style="position: absolute; right: 0px; bottom: 20px;">Edit</button>
                </c:if>
                <c:if test="${quiz.isIsTaken()}">
                    <h4 style="float: right; margin-right: 20px">This quiz is taken!</h4>
                </c:if>
            </div>
        </div>
    </main>
