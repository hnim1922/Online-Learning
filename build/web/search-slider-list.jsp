    ...
    <body>
        ...
        <div class="slider-list-container" style="width: 100%;">
            ...
            <<div class="page-route">
                <c:forEach var="i" begin="1" end="${allSearchedSliderList.size()/3}">
                    <a href="SearchSliderList?page=${i}&keyword=<%=session.getAttribute("keyword")%>" <c:if test="${param.page == i}">class="on-page"</c:if>>${i}</a>  
                </c:forEach>
            </div>
        </div>
    </body>
