...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="registrations-style.css">
        ...
        <main>
            ...
            <div class="course-list-container ">
                <div class="blog-detail-title">
                    <h1><strong>My registrations</strong></h1>
                    <c:if test="${empty sessionScope.PAIDALL}">
                        <sub id="blog-author">ID: ${sessionScope.regisID}</sub> <br><br><sub id="blog-author">Registration time: ${sessionScope.registrationTime}</sub><br><br><sub id="blog-author">Valid To: ${sessionScope.validTo}</sub><br><br>
                        <div class="blog-detail-thumbnail">
                            <div class="latest-post">

                                <c:forEach items="${sessionScope.courseList}" var="course">
                                    <div class="course">
                                        <img class="course-list-thumbnail" src="${course.subject.thumbnail}">
                                        <div class="course-title ">
                                            <a href="CourseDetails?subjectID=${course.subject.subjectID}">
                                                <strong>${course.title}</strong>

                                                <sub>$${course.subject.pricePackage.salePrice}</sub>
                                            </a>
                                        </div>
                                        <a class="deletebtn" href="DeleteCourse?courseID=${course.courseID}">
                                            <img src="images/ui-images/Close Square.svg" />
                                        </a>
                                    </div>
                                </c:forEach>
                    ...
                    <div>
                        <h2 class="total-price">Total: $${sessionScope.totalCost}</h2>
                    </div>
                    <div class="buttons">
                        <button class="login-btn" onclick="location.href = 'CheckOut'">Check out</button>
                        <button class="signup-btn" onclick="location.href = 'DeleteAll'">Delete all</button>
                    </div>
                </c:if>
                <c:if test="${!empty sessionScope.PAIDALL}">
                    ${sessionScope.PAIDALL}
                </c:if>
            </div>
        </main>
    </body>
