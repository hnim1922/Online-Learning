            ...
            <div class="course-list-container" style="width: 100%;">
                <div class="course-list">
                    <c:forEach var="subject" items="${subjectList}">
                        <div class="course-card not-study"
                             onclick="location.href = 'CourseDetails?subjectID=${subject.subjectID}';">
                            ...
                            <div class="list-price" style="text-decoration: line-through;margin-left: 20px;">
                                $${subject.pricePackage.listPrice}</div>
                            <h3 class="sale-price">$${subject.pricePackage.salePrice}</h3>
                            <a href="#start-course" class="login-btn"
                ...
                <div class="page-route">
                    <c:forEach var="i" begin="1" end="${Math.ceil(allSubjectList.size()/3)}">
                        <a href="CourseList?page=${i}" <c:if test="${param.page == i}">class="on-page"</c:if>
                           >${i}</a>
                    </c:forEach>
                </div>
            </div>
