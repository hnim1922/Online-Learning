...
<html lang="en">
    ...
    <body>
        ...
        <header>
            ...
            <!-- LESSON CHANGE BOX -->
            <div id="lesson-change-form" class="modal">
                <form action="ChangeLessonInfo?lessonID=${lesson.getLessonID()}" method="POST" class="modal-content animate">
                    <table>
                        <tr>
                        <h1 class="information">Change Lesson information form</h1>
                        </tr>
                        <tr>
                            <td> Lesson ID:</td>
                            <td><input disabled="" type="text" value="${lesson.getLessonID()}" readonly/>
                                <input type="hidden" name="lessonID" value="${lesson.getLessonID()}"/>
                            </td>
                        </tr>
                        <tr>
                            <td> Lesson Name:</td>
                            <td><input type="text" name="lessonName" value="${lesson.getLessonName()}" required/></td>
                        </tr>
                        <tr>
                            <td> Lesson Content</td>
                            <td><textarea name="lessonContent" rows="4" cols="50">${lesson.getContent()}</textarea></td>
                        </tr>
                        <tr>
                            <td colspan="2"><input class="login-btn" type="submit" value="Change"></td>
                                <c:if test="${empty requestScope.INVALID}">
                                <td>                        
                                    <button class="login-btn" type="reset" onclick="document.getElementById('lesson-change-form').style.display = 'none'">Cancel</button></td>
                                </c:if>
                        </tr>
                    </table>
                </form>         
        ...
        <main>
            <div class="sider-course-list">
                <button onclick="document.getElementById('lesson-change-form').style.display = 'block'" class="login-btn">Edit Lesson</button>
                <h3>Contact us</h3>
