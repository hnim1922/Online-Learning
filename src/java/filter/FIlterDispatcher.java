    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (resource.length() > 0) {
                ...
                if (resource.indexOf(".html") > 0 || resource.indexOf(".css") > 0 || resource.indexOf(".svg") > 0 || resource.indexOf(".jsp") > 0 || resource.indexOf(".jpg") > 0 || resource.indexOf(".png") > 0 || resource.indexOf(".jpeg") > 0)
                    url = resource;
            }
            if (url != null) {
