 ...
 * @author Admin
 */
public class ChangeSalServlet extends HttpServlet {

    private static final String fail = "error.jsp";
    private static final String success = "salview.jsp";
    private static final String invalid = "salview.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR at ChangeSalController: " + e.getMessage());
            e.printStackTrace();
        } finally {
