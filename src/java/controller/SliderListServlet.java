    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("keyword") == null) {
                sliderList = dao.getAllSlider(pageId, total);
            } else {
                sliderList = dao.getSliderbyTitle(request.getParameter("keyword"), pageId, total);
            }
            request.setAttribute("allSliderList", dao.getAllSlider());
