 ...
 * @author Admin
 */
public class ChangeCusServlet extends HttpServlet {

    private static final String fail = "error.jsp";
    private static final String success = "cusview.jsp";
    private static final String invalid = "cusview.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR at ChangeCusController: " + e.getMessage());
            e.printStackTrace();
        } finally {
