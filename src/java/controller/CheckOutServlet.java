...
public class CheckOutServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            boolean result = regisDAO.updateStatus(userID);

            if (result){
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Check out sucessful. Have fun with your courses');");
                 out.println("location='Homepage';");
                out.println("</script>");
            } else {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Sorry. Your registration is failed to check out');");
                 out.println("location='Homepage';");
                out.println("</script>");
            }
