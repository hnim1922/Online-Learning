 ...
 * @author ihtng
 */
public class SearchQuizListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (user != null) {
                ...
                allQuizSearch = quizDAO.getQuizByName(keyword);
                allQuizSearchPaginated = quizDAO.getQuizByNamePaginated(keyword, pageId, total);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SearchQuizListServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
