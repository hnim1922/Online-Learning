    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (filter.equals("fullname")) {
                lst = dao.getAllUserbyName(request.getParameter("input"));
            } else if (filter.equals("email")) {
                lst = dao.getAllUserbyEmail(request.getParameter("input"));
            } else {
                lst = dao.getAllUserbyPhone(request.getParameter("input"));
            }
