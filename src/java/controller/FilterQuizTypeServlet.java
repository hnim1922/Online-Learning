 ...
 * @author ihtng
 */
public class FilterQuizTypeServlet extends HttpServlet {
 ...
 try (PrintWriter out = response.getWriter()) {
            ...
            if (user != null) {
                ...
                allQuizSearch = quizDAO.getQuizByType(quizType);
                allQuizSearchPaginated = quizDAO.getQuizByTypePaginated(quizType, pageId, total);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FilterQuizTypeServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
