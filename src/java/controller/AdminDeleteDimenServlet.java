 ...
 * @author Admin
 */
public class AdminDeleteDimenServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int id = Integer.parseInt(request.getParameter("dimenid"));
            
            dao.deleteDimension(id);
            url = success;
        }
        catch(Exception e){
            e.printStackTrace();
            log("ERROR at AdminDeleteDimenServlet: "+e.getMessage());
        }
        finally{
