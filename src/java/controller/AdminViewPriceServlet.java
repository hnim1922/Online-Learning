 ...
 * @author Admin
 */
public class AdminViewPriceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int priceid = Integer.parseInt(id);
            PricePackageDAO dao = new PricePackageDAO();
            PricePackage price = dao.getPricePackageByPricePackageId(priceid);
            System.out.println(price.getPricePackageID());
            ...
            e.printStackTrace();
            log("ERROR at AdminViewPriceServlet: " + e.getMessage());
        } finally {
