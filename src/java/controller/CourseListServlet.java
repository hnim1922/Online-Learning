    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (request.getParameter("keyword") == null) {
                subjectList = subjectDAO.getAllSubjectWithLowestPricePackage(pageId, total);
            } else {
                subjectList = subjectDAO.getSubjectByName(request.getParameter("keyword"), pageId, total);
            }
            request.setAttribute("allSubjectList", subjectDAO.getAllSubjectWithLowestPricePackage());
