 ...
 * @author Admin
 */
public class ChangeExpServlet extends HttpServlet {

    private static final String fail = "error.jsp";
    private static final String success = "expview.jsp";
    private static final String invalid = "expview.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR at ChangeExpController: " + e.getMessage());
            e.printStackTrace();
        } finally {
