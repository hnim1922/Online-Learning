    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@page contentType="text/html" pageEncoding="UTF-8" %>
            ...
            <head>
                ...
                <link rel="stylesheet" href="registration-list-style.css">
                        ...
                        <form action="FilterRegistration" class="modal-content animate" method="POST" style="width: 40%;">
                            ...
                            <option value="sort-by-status">Sort by status</option>
                                    ...
                                    <div style="display: flex; justify-content: center;">
                                        ...
                                        <button class="cancel-btn" onclick="document.getElementById('filter-pop-up').style.display = 'none'; location.href='registration-list.jsp'">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="container">
                                <div class="txt">
                                    ...
                                    <div style="display: flex; justify-content: center">
                                        ...
                                        <button class="cancel-btn" onclick="document.getElementById('edit-validTo').style.display = 'none'">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <main>
                    ...
                    <div class="course-list-container ">
                        <div class="blog-detail-title">
                            <h1><strong>Users' registrations</strong></h1>
                            <div class="tool" onclick="document.getElementById('filter-pop-up').style.display = 'block'">
                                <img src="images/ui-images/filter.png">
                            </div>
                            <div onclick="document.getElementById('edit-validTo').style.display = 'block'">
                                <img class="edit-btn" src="images/ui-images/edit.png" />
                            </div>
                            <div class="latest-post">
                                <c:forEach items="${sessionScope.regisList}" var="regis">
                                    <div class="regis-container" onclick="location.href = 'RegistrationDetail?userID=${regis.userID}&regisID=${regis.regisID}'">
                                        <div class="regis-card">
                                            <div class="regis-info">
                                                <a>
                                                    <strong>${regis.userID} - ${regis.userEmail}</strong>
                                                    <sub>Registration ID : ${regis.regisID}</sub>
                                                    <sub>${regis.validFrom} to ${regis.validTo}</sub>
                                                </a>
                                            </div>
                                            <c:if test="${regis.status == 1}">
                                                <div class="regis-status" style="background-color: #28a745;">Paid</div>
                                            </c:if>
                                            <c:if test="${regis.status == 0}">
                                                <div class="regis-status" style="background-color: #cf000f;">Unpaid</div>
                                            </c:if>
                                        </div>
                                    </div>
                                </c:forEach>
